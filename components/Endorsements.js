...
function Endorsements() {
  ...
  return (
    <div className=''>
         {/* Endorsements */}
      <div className='text-center my-16 mb-8 sm:my-32 sm:mb-12 px-6 max-w-5xl mx-auto'>
                                    ...
                                    <SwiperSlide key={endorsement._id}>
                                                        <div className='sm:flex py-6 px-6 text-left border-[1px] border-[#182033]'>
                                                            <div className='w-[100px] sm:w-2/12 mb-6 sm:mb-0'>
                                                                <div className='w-24 h-24 rounded-full overflow-hidden text-right relative'>
                                                                    <Image
                                                            ...
                                                            <div className='sm:w-10/12'>
                                                                <p className='text-[14px] sm:text-base  text-gray-200 text-left leading-7 '>{endorsement.text}</p>
