  ...
  return (
    ...
    <div className='mt-5 sm:mt-0 w-full group sm:hover:scale-105 transition-all duration-500' key={key}>
          ...
          <div className='relative'>
            ...
            <div className='bg-gradient-to-b from-[#000000a5] absolute top-0 left-0 h-[20%] w-[100%] z-10' />
            <div className='bg-gradient-to-t from-[#000000d9] absolute bottom-[5px] left-0 h-[50%] w-full z-10' />
