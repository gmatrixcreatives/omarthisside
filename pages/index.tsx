        ...
        <div className='innerDiv max-auto 2xl:px-0 xl:px-[80px] lg:px-[80px] md:px-[60px] xs:px-[0]'>
          <div className='flex md:-mx-3 flex-wrap'>
            <div className='md:px-3 lg:w-1/2 md:w-1/2 w-full md:order-1 order-2  md:mt-0 mt-4 sm:mx-0 mx-[5px]'>
              ...
              <div className='px-4 py-5 flex-auto border rounded lg:min-h-[360px]'>
                <div className='tab-content tab-space'>
                  ...
                  <div className={openTab === 2 ? "block" : "hidden"} id='link2'>
                    <div className='flex items-center sm:justify-start justify-between mb-6'>
                      <h3 className='sm:text-[20px] text-base font-[600]'>Subtitles</h3>
                      <div className='relative'>
                        <a
                          onClick={() => {
                            setShowDrop(!showDrop);
					...
					<div className='text-center py-6 hidden'>
                      ...
                      <p className='mt-2'>Add a new subtitle</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className='md:px-3 lg:w-1/2 md:w-1/2 w-full md:order-2 order-1'>
              <iframe
                ...
                title='Polynomials intro (Hindi)'
                width='100%'
                height='400px'
                src='https://www.youtube.com/embed/CzI4pIx3wuQ?autoplay=0&amp;rel=0&amp;enablejsapi=1&amp;origin=https%3A%2F%2Fcourse.gurucool.xyz&amp;widgetid=1'
                id='widget2'></iframe>
            </div>
          </div>
        </div>
